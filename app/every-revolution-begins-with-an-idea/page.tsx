...
export default function EveryRevolutionPage() {
  return (
      ...
      <section className="relative overflow-hidden pt-32 pb-24 sm:pb-32 lg:pt-40 lg:pb-40 min-h-[60vh] lg:min-h-[70vh]">
        ...
        <div className="absolute inset-0 -z-20">
          <div 
            ...
            style={{
              backgroundImage: 'url(/img/whitepapers_grid/every_revolution_begins_with_an_idea.jpg)'
            }}
          />
      ...
      <section className="relative pt-24 pb-24">
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex justify-center">
            <Link 
              href="/downloads/Xcoin Whitepaper 1.pdf" 
              target="_blank"
