...
export default function PathToBitcoinReplacementPage() {
  return (
    <div className="relative overflow-hidden">
      {/* Hero Section mit Hintergrundbild - größer gemacht */}
      <section className="relative overflow-hidden pt-32 pb-24 sm:pb-32 lg:pt-40 lg:pb-40 min-h-[60vh] lg:min-h-[70vh]">
        {/* Hintergrundbild - markanter */}
        <div className="absolute inset-0 -z-20">
          <div 
            className="h-full w-full bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: 'url(/img/whitepapers_grid/the_path_to_bitcoin_replacement.jpg)'
            }}
          />
          {/* Leichteres Overlay, damit Bild markanter ist */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="font-[family-name:var(--font-heading)] text-4xl font-bold tracking-tight lg:text-5xl mb-6 text-white">
              The Path to Bitcoin Replacement
            </h1>
      ...
      {/* PDF Download Section mit Feuer-Rahmen - komplett klickbar */}
      <section className="relative pt-24 pb-24">
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex justify-center">
            <Link 
              href="/downloads/Xcoin Whitepaper 2.pdf" 
              target="_blank"
